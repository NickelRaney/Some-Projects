function [err,t,count]=multiineuzawa(iter1,iter2,l,n,w,iter3)
%Inexact Uzawa多重网格,iter1为下降磨光次数，iter2为上升磨光次数，l为下降层数，最大为n-2，网格规模为2^n，w为\alpha，iter3为多重网格磨光子的迭代次数
u=cell(n,1);
v=cell(n,1);
f=cell(n,1);
g=cell(n,1);
...
while 1
    for i=n:-1:n-l+1
        ...
        [u{i},v{i},p{i}]=ineuzawa(i,p{i},f{i},g{i},d{i},iter1,w,iter3);
    ...
    for i=n-l+1:n
        ...
        [u{i},v{i},p{i}]=ineuzawa(i,p{i},f{i},g{i},d{i},iter2,w,iter3);
    end
